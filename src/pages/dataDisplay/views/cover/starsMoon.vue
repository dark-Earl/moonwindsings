<template>
  <div>
    <div id="background">
      <div class="box">
        ...
        <template >
          <div :class="{line1: index===1,lineover: index>1}" v-for="index in 5" :key="index">
            <div class="box1 stars" v-for="(item,index2) in dataSub['sub'+index]">
              <div class="box2 stars">
                <div :class="{'box3':true,'stars':true}">
      ...
      <div class="moonBox">
        <div :class="{line1: index===1,lineover: index>1}" v-for="index in 2" :key="index">
          <div class="box1 moon" v-for="(item,index2) in dataHead['sub'+index]">
            <div class="box2 moon">
              <div class="box3 moon">
                <img :src="item.picUrl" alt="">
              </div>
...
export default {
  ...
  methods: {
    initData () {
      let json = require('@/assets/json/hurunRicher/2021China.json')
      this.dataArr = json
      this.dataHead.sub1 = this.dataArr.slice(0,1)
      this.dataHead.sub2 = this.dataArr.slice(1,3)
