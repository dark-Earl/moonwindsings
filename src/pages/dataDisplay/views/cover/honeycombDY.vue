...
export default {
  ...
  methods: {
    initData () {
      let json = require('@/assets/json/dataShow/rankHKGold.json')
      this.dataArr = json
      this.dataArr = this.dataArr.reverse()
      this.dataSub.sub1 = this.dataArr.slice(0,7)
      this.dataSub.sub2 = this.dataArr.slice(7,13)
      this.dataSub.sub3 = this.dataArr.slice(13)
    },
    loadFireFly () {
