<template>
  <div>
    <div>
      <div id="indexPage">
        <div id="container">
          <canvas width="800" height="480" id="canvasA" style="border: 1px solid #ccc;"></canvas>
        </div>
      ...
      >
        ...
        <p>
          <a-button @click="addTextAdvan">小说预设文字</a-button>
        </p>
        <p>
...
export default {
  ...
  methods: {
    ...
    addText() {
      ...
      const text = new fabric.IText('类型', {
        top: 200,
        left: 240,
        fontSize: 55,
        backgroundColor: '', // 背景色：绿色
        fill: '#f3ec37', // 填充色：橙色
    ...
    addTextAdvan() {
      ...
      const text = new fabric.IText('一口气看完系列\n\n        已完结\n\n' +
        '     类型+重生', {
        top: 100,
        left: 100,
        fontSize: 55,
